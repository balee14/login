...
import com.chatbot.adjustment.web.common.exception.RestError;
...
public class GlobalRestControllerExceptionHandler {
	...
	public RestError handle404(HttpServletRequest req, Exception e) {
		return new RestError(HttpStatus.NOT_FOUND.value(), req.getRequestURL().toString(), e.getMessage(), e.getClass().getName());
	}
